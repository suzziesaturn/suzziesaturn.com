          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {["Slides","Tees","Hoodies","Bandanas","All Products"].map(item => (
                <li key={item}><Link href="#" className="font-sans text-xs font-medium tracking-wide text-white/60 transition-colors hover:text-white">{item}</Link></li>
              ))}
            </ul>
          </div>
          <div>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3">
              {[["@suzziesaturn","#"],["Instagram","#"],["TikTok","#"],["X / Twitter","#"]].map(([label,href]) => (
                <li key={label}><Link href={href} className="font-sans text-xs font-medium tracking-wide text-white/60 transition-colors hover:text-white">{label}</Link></li>
              ))}
            </ul>
          </div>
        </div>

...
export default function Hero() {
  return (
    <section className="flex flex-col bg-black text-white" style={{ padding: "clamp(48px,8vw,96px) clamp(24px,5vw,72px)" }}>
      ...
      <Link href="#shop" className="inline-block border border-white px-10 py-4 font-sans font-bold uppercase tracking-[0.25em] transition-colors hover:bg-white hover:text-black" style={{ fontSize: "clamp(11px,1.1vw,12px)" }}>
        Shop Now
      </Link>
    </section>
  );

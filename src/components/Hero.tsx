...
export default function Hero() {
  return (
    ...
    >
      ...
      <Link href="#shop" className="relative inline-block border border-white px-10 py-4 font-sans font-bold uppercase tracking-[0.25em] transition-colors duration-300 hover:bg-white hover:text-black" style={{ fontSize: "clamp(11px,1.1vw,12px)" }}>
        Shop Now
      </Link>
    </section>
  );

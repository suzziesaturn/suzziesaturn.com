export default function VideoBlock() {
  return (
    <div className="group relative flex cursor-pointer flex-col items-center justify-center overflow-hidden bg-[#0a0a0a] aspect-[9/16] sm:aspect-[16/9]" style={{ gap: "20px" }}>
